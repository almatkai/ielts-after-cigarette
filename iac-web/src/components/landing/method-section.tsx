  ...
  return (
    <div>
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="grid size-10 place-items-center rounded-[10px] bg-[#fff0f0] text-[#e23b3b]">
          <RouteSquare
            size={21}
            color="currentColor"
            variant="Linear"
      ...
      <div className="mt-10 space-y-5">
        {[
          ...
          >
            ...
            <span className="text-[#69696d]">{focus}</span>
            <div className="col-span-2 h-1 rounded-full bg-[#e7e7e4]">
              <div
      ...
      <p className="mt-8 border-t border-[#e7e7e4] pt-5 text-sm text-[#69696d]">
  ...
  return (
    <div>
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="grid size-10 shrink-0 place-items-center rounded-[10px] bg-[#fff0f0] text-[#e23b3b]">
          <DocumentText
            size={21}
            color="currentColor"
            variant="Linear"
      ...
      <div className="mt-8 grid grid-cols-3 border-y border-[#e7e7e4] py-5 text-center">
        <div>
          <span className="block text-lg font-semibold">18</span>
          <span className="text-xs text-[#69696d]">минут</span>
        </div>
        <div className="border-x border-[#e7e7e4]">
          <span className="block text-lg font-semibold">8</span>
          <span className="text-xs text-[#69696d]">вопросов</span>
        </div>
        <div>
          <span className="block text-lg font-semibold">6,0</span>
          <span className="text-xs text-[#69696d]">уровень</span>
        </div>
      </div>
      <ol className="mt-7 space-y-4 text-sm">
        {[
          ...
          <li key={item} className="flex items-center gap-3">
            <span className="grid size-6 place-items-center rounded-full bg-[#f4f4f1] text-[11px] font-semibold">
              {index + 1}
            </span>
            {item}
          </li>
...
function ReviewPreview() {
  return (
    <div>
      ...
      <div className="mt-8 rounded-[10px] bg-[#f4f4f1] p-5">
      ...
      <div className="mt-7 flex items-center justify-between border-b border-[#e7e7e4] pb-4 text-sm">
        <span className="text-[#69696d]">Следующий полезный шаг</span>
        <span className="font-semibold">Короткий повтор</span>
      </div>
      <div className="mt-5 flex items-center gap-2 text-xs text-[#69696d]">
...
export function MethodSection() {
  ...
  return (
    <section
      id="method"
      className="section-shell scroll-mt-20 border-y border-[#e7e7e4] bg-white"
        ...
        <div className="mt-14 grid gap-12 lg:grid-cols-12 lg:items-center">
                ...
                return (
                  <li key={step.number} className="relative">
                    {index < methodSteps.length - 1 ? (
                      <>
                        <span
                          className="pointer-events-none absolute top-10 -bottom-2 left-[23.5px] w-px bg-[#e7e7e4]"
                          aria-hidden
                        />
                        <motion.span
                          className="pointer-events-none absolute top-10 -bottom-2 left-[23.5px] w-px bg-[#e23b3b]"
                          initial={false}
                    ...
                    >
                      <span
                        className={cn(
                          ...
                          isActive &&
                            'border-[#e23b3b] bg-[#e23b3b] text-white',
                          isComplete && 'border-[#e23b3b] text-[#e23b3b]',
                          !isActive &&
                            !isComplete &&
                            'border-[#d8d8d4] text-[#69696d]',
                        )}
                      >
                        {step.number}
                      </span>
                      <span className="relative z-10 pt-1">
                        ...
                        <span className="mt-2 block max-w-xl text-sm leading-6 text-[#69696d] transition-colors group-hover:text-[#4f4f53] sm:text-base sm:leading-7">
                          {step.description}
                        </span>
                      </span>
                    </button>
          ...
          <RevealInView delay={0.08} className="lg:col-span-5">
            <div className="product-panel min-h-[430px] p-6 sm:p-8">
              <div className="mb-10 flex items-center justify-between text-xs text-[#8b8b8e]">
