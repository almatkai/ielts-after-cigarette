...
function PreviewHeader({
  ...
  return (
    <div className="flex items-center justify-between gap-4 border-b border-[#e2e8f0] px-5 py-4 sm:px-7">
      <div className="flex items-center gap-3">
        <span className="grid size-9 place-items-center rounded-[10px] bg-[#f8fafc] text-[#0f172a]">
  ...
  return (
    <div className="skill-interface">
      ...
      <div className="grid min-h-[390px] md:grid-cols-[1.25fr_0.75fr]">
        <div className="border-b border-[#e2e8f0] p-5 sm:p-7 md:border-r md:border-b-0">
          ...
          <div className="mt-12 flex items-center gap-4">
            <span
              className="grid size-11 shrink-0 place-items-center rounded-full bg-[#0f172a] text-white"
          ...
          <div className="mt-10 flex items-center justify-between border-t border-[#e2e8f0] pt-5 text-xs text-[#475569]">
            <span>00:48</span>
        ...
        <div className="flex flex-col p-5 sm:p-7">
          ...
          <div className="mt-6 space-y-2.5 text-sm">
            {['В 9:15', 'В 9:30', 'В 9:45'].map((answer, index) => (
              <div
                key={answer}
                className={`flex min-h-11 items-center gap-3 rounded-[10px] border px-3 ${index === 1 ? 'border-[#0f172a] bg-[#f8fafc]' : 'border-[#e2e8f0]'}`}
              >
                <span className="grid size-5 place-items-center rounded-full border border-[#cbd5e1] text-[10px]">
      ...
      <div className="grid min-h-[390px] md:grid-cols-[1.15fr_0.85fr]">
        <div className="border-b border-[#e2e8f0] p-5 sm:p-7 md:border-r md:border-b-0">
          <div className="mb-5 flex gap-5 text-xs font-semibold">
            <span className="text-[#0f172a]">Текст</span>
            <span className="text-[#64748b]">Вопросы</span>
          </div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-7 text-[#475569]">
            ...
            <p>
              <mark className="bg-[#eff6ff] px-1.5 py-0.5 text-[#0f172a]">
        ...
        <div className="flex flex-col p-5 sm:p-7">
          ...
          <div className="mt-6 rounded-[10px] bg-[#f8fafc] p-4 text-sm leading-6 text-[#475569]">
...
function WritingPreview() {
  ...
  return (
    <div className="skill-interface">
      ...
      <div className="grid min-h-[390px] md:grid-cols-[1.25fr_0.75fr]">
        <div className="border-b border-[#e2e8f0] p-5 sm:p-7 md:border-r md:border-b-0">
          <div className="rounded-[10px] bg-[#f8fafc] p-4 text-sm leading-6">
            <span className="mb-2 block text-xs font-semibold tracking-[0.08em] text-[#475569] uppercase">
              Задание
            </span>
        ...
        <div className="p-5 sm:p-7">
          ...
          <div className="mt-7 divide-y divide-[#e2e8f0] border-y border-[#e2e8f0]">
            {categories.map((category, index) => (
              ...
              >
                <span>{category}</span>
                <span
                  className={`size-2 rounded-full ${index === 1 ? 'bg-[#3b82f6]' : 'bg-[#cbd5e1]'}`}
                  aria-hidden
                />
              </div>
            ))}
    ...
    <div className="skill-interface">
      ...
      <div className="grid min-h-[390px] md:grid-cols-[0.85fr_1.15fr]">
        <div className="border-b border-[#e2e8f0] p-5 sm:p-7 md:border-r md:border-b-0">
          ...
          <div className="mt-8 flex justify-between border-t border-[#e2e8f0] pt-5 text-xs text-[#475569]">
        ...
        <div className="flex flex-col items-center justify-center p-5 text-center sm:p-7">
          <span className="relative grid size-24 place-items-center rounded-full border border-[#e2e8f0] bg-[#ffffff]">
            <span
              className="absolute inset-2 rounded-full border border-[#3b82f6]/25"
              aria-hidden
            />
            <Microphone2
              size={28}
          ...
          <span className="mt-6 text-xs font-semibold tracking-[0.08em] text-[#3b82f6] uppercase">
            Запись
          </span>
          ...
          >
            {Array.from({ length: 12 }, (_, index) => (
              <span
                key={index}
                className={`h-1 flex-1 rounded-full ${index < 8 ? 'bg-[#0f172a]' : 'bg-[#e2e8f0]'}`}
              />
            ))}
          </div>
