...
export function SpeakingStudentPage({
  materialId,
  fullMockSessionId,
}: {
  materialId: string
  ...
  return (
    <ExamAttemptShell<PublicSpeakingMaterial>
...
export function SpeakingAttemptResult({
  attempt,
  material,
  fullMockSessionId,
  onRetake,
  ...
  return (
    <div className="space-y-6">
      <AttemptPerformanceReport
        ...
        durationMinutes={material.parts.length * 5}
        paceUnit="часть"
      />
